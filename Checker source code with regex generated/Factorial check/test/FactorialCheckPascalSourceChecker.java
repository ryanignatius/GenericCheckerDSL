...
public class FactorialCheckPascalSourceChecker {
  private Scanner sc;
  ...
  public boolean p1() {
    ...
    for (int i=0; i<source_arr.size(); i++){
      String s = "(?s)(\\s*)\\bfunction\\b(\\s*)(\\s+)(\\s*)\\bfac\\b(\\s*)\\((\\s*)\\bn\\b(\\s*):(\\s*)\\binteger\\b(\\s*)\\):(\\s*)\\binteger\\b(\\s*)(.*)(\\s*)\\bfac\\b(\\s*)\\((.*)(\\s*)\\bn\\b(\\s*)(.*)\\)";
